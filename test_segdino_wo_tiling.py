...
from spider_utils.transforms import make_resize_normalize_transform
...
def main():
    ...
    test_transform = make_resize_normalize_transform(size=(args.input_h, args.input_w))
